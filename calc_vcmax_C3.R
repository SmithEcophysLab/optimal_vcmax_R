# calculate optimal vcmax for C3 plants as in Smith et al. Photosynthetic capacity is optimized to the 
...
calc_vcmax_C3 <- function(tg_c = 25, z = 0, vpdo = 1, cao = 400, oao = 209460,
